...
# 1) SignatureValue –  checksum or hash sum, a line of a 32-bit 16-nary number
...
# 2) «Контрольная сумма - хэш, число в 16-ричной форме и любом регистре (0-9, A-F),
...
# Это очень важный параметр, который обеспечивает безопасность при прохождении платежа и целостность передаваемых данных.
# Корректное его составление гарантирует, что злоумышленник не сможет подделать какие-либо данные в операции оплаты.»
