...
# База для расчёта контрольной суммы: OutSum:InvId:Пароль#2 — если Вы не передавали пользовательские параметры.»
...
final class Response extends \Dfe\Robokassa\Signer {
	 ...
	 * @return string[]
	 */
	protected function values():array {return [$this->v(['OutSum', 'InvId']), $this->s()->password2()];}
}